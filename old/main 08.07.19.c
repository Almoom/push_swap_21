...
int main(int argc, char **argv)
{
	...
	// 95 76 22 5 50 45 26 94 23 92 46 38 13 67 82 81 88 97 64 27 43 11 96 33 93 4 85 61 25 36 83 57 59 21 70 49 24 20 86 72 31 60 28 44 54 69 48 2 79 90 30 73 99 53 32 14 51 9 8 78 39 10 42 16 58 98 56 7 52 66 71 35 37 89 12 47 63 41 17 55 91 15 100 75 1 6 3 65 74 87 68 19 62 77 40 80 34 84 29 18
	int mid;
	int lena;
	t_l *head;
	...
	if (argc > 3)
	{
		head = create_pre(argc, argv);
		head = presort(head);
		//print_l(head);
		mid = lena = 0;
		mid = findmiddle(head, argc);
		//printf("--%d\n", mid);
		lena = len_a(head, mid);
		//printf("--%d\n", lena);
		create_stakes(argc, argv, lena, mid);
	}
